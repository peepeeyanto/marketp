              ...
              <div class="wsus__dash_pro_area">
                ...
                <form action="{{route('seller.shop-profile.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-check form-switch mt-2">
                        <input class="form-check-input" type="checkbox" name='is_localdelivery' id="islocaldelivery">
                        <label class="form-check-label" for="localdelivert">Nyalakan pengiriman independen</label>
                    </div>

                    <div class="form-check form-switch">
                        <input class="form-check-input" name='is_cod' type="checkbox" id="iscod" disabled>
                    ...
                    <div class="form-group wsus__sinput">
                        <input class="form-control" name='base' id="base" type="text" placeholder="Tarif dasar pengiriman independen" disabled >
                        <input class="form-control" name='perkm' id="perkm" type="text" placeholder="Tarif per/KM pengiriman independen" disabled >
                    </div>
