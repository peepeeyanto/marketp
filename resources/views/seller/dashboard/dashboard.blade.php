                ...
                @if (!empty(Auth::user()->vendor->id))
                    <div class="row">
                        <div class="col-xl-2 col-6 col-md-4">
                            <a class="wsus__dashboard_item red" href="{{route('seller.orders.index')}}">
                        ...
                        <div class="col-xl-2 col-6 col-md-4">
                            <a class="wsus__dashboard_item green" href="{{route('seller.orders.index')}}">
                        ...
                        <div class="col-xl-2 col-6 col-md-4">
                            <a class="wsus__dashboard_item sky" href="{{route('seller.orders.index')}}">
                        ...
                        <div class="col-xl-2 col-6 col-md-4">
                            <a class="wsus__dashboard_item blue" href="{{route('seller.orders.index')}}">
                        ...
                        <div class="col-xl-2 col-6 col-md-4">
                            <a class="wsus__dashboard_item orange" href="{{route('seller.report.index')}}">
                        ...
                        <div class="col-xl-2 col-6 col-md-4">
                            <a class="wsus__dashboard_item purple" href="{{route('seller.products.index')}}">
                        ...
                        <div class="col-xl-2 col-6 col-md-4">
                            <a class="wsus__dashboard_item sky" href="{{route('seller.reviews.index')}}">
                                <i class="fas fa-star"></i>
                                <p>Total Ulasan</p>
